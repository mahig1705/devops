...
const Home = ({ userEmail, userRole }) => {
    ...
    useEffect(() => {
        ...
        const fetchFeedbacks = async () => {
            try {
                const res = await axios.get('http://13.61.64.60:5000/api/feedback');
        ...
        const fetchStats = async () => {
            try {
                ...
                const [complaintsRes, usersRes] = await Promise.all([
                    axios.get('http://13.61.64.60:5000/api/stats/complaints'),
                    axios.get('http://13.61.64.60:5000/api/stats/users')
                ]);
